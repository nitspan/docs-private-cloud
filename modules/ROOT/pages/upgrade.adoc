...
* Perform a backup of your system as described in xref:backup-and-disaster-recovery.adoc[About Backup and Recovery].

* Ensure that your environment meets all of the system and network requirements described in xref:system-requirements.adoc[About Minimum System Requirements]
...
. Navigate to the `anypoint-1.5.2` directory, then run the upload script.
+
----
sudo ./upload
----
