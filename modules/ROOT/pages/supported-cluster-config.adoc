...
[WARNING]
Only VMWare bare metal virtualization environments and physical servers are supported. For information on using VMWare, see xref:prereq-create-vm-vmware.adoc[Creating a Virtual Machine using VMWare].
