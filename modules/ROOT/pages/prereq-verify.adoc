...
* https://docs.docker.com/engine/userguide/storagedriver/device-mapper-driver/[Docker and the DeviceMapper Storage Driver]
* https://linuxconfig.org/linux-lvm-logical-volume-manager[Linux lvm - Logical Volume Manager]