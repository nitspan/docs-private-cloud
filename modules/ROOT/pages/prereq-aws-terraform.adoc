...
[%header%autowidth.spread]
|===
| TF_VAR_ami_name | Enables you to specify the version of RedHat or CentOS AMI. If you do not set this variable, the provisioner uses the folowing AMI by default: `RHEL-7.4_HVM_GA-20170808-x86_64-2-Hourly2-GP2`.
